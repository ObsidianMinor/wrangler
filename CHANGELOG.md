...
- ### Maintenance
  ...
  - **Use binary-install for npm - [EverlastingBugstopper], [pull/862]**
    ...
    This extracts a lot of the logic in Wrangler's installer to an external package, [binary-install], which we will also use for installing wasm-pack on webpack project builds. Long term this will move us toward not re-installing wasm-pack on each build. It also includes the logic for uninstalling the downloaded binaries.
